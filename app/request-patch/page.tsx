...
export default function RequestPatchPage() {
  ...
  return (
    <div className="p-6 max-w-xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">Request a Missing Patch</h1>
      <p className="mb-4 text-gray-600">
        If there’s a patch you'd like to see added, let us know below.
      </p>
      ...
      <label className="block mb-3">
        ...
        <textarea
          ...
          className="block w-full border p-2 rounded mt-1"
          rows={5}
          placeholder="Tell us the patch name, where to get it, and any relevant links."
        />
      </label>
